...
namespace ShopSolution.Application.Catalog.Products
{
    public class ManageProductService : IManageProductService
    {
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new ShopException($"Can't not find a product: {productId}");
        ...
        public async Task<int> RemovseImage(int imageId)
        {
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new ShopException($"Can't find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new ShopException($"Can't find a product with id: {productId}");
